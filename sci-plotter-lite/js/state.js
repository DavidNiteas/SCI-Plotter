...
const AppState = {
    ...
    mainfigure: {
        ...
        autoNumbering: true,
        numberingFormat: '(a)',
        numberingFontSize: 18,
        numberingPosition: 'top-left',
        numberingCounter: 0,
    },
...
function exportWorkspace() {
    return {
        ...
        mainfigure: {
            ...
            autoNumbering: AppState.mainfigure.autoNumbering,
            numberingFormat: AppState.mainfigure.numberingFormat,
            numberingFontSize: AppState.mainfigure.numberingFontSize,
            numberingPosition: AppState.mainfigure.numberingPosition,
            numberingCounter: AppState.mainfigure.numberingCounter,
            layers: AppState.mainfigure.layers.map(l => ({
                ...
                _parentSubfigureId: l._parentSubfigureId,
                _sciLocked: l.fabricObject?._sciLocked || false,
